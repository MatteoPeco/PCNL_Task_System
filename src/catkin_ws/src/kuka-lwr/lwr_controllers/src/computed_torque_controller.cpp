...
namespace lwr_controllers 
{
	...
	void ComputedTorqueController::starting(const ros::Time& time)
	{
  		...
  		for(size_t i=0; i<joint_handles_.size(); i++) 
  		{
    		...
    		ROS_INFO("%f", joint_msr_states_.q(i));
    ...
    void ComputedTorqueController::update(const ros::Time& time, const ros::Duration& period)
    {
    	...
    	/*
    	//  added JLF 2022.05.12
    	ROS_INFO("Mass 00 = %f",M_(0,0));
    	ROS_INFO("Mass 01 = %f",M_(0,1));
    	ROS_INFO("Mass 02 = %f",M_(0,2));
    	ROS_INFO("Mass 03 = %f",M_(0,3));
    	ROS_INFO("Mass 04 = %f",M_(0,4));
    	ROS_INFO("Mass 05 = %f",M_(0,5));
    	ROS_INFO("Mass 06 = %f",M_(0,6));  	
    	ROS_INFO("Mass 10 = %f",M_(1,0));
    	ROS_INFO("Mass 20 = %f",M_(2,0));
    	ROS_INFO("Mass 30 = %f",M_(3,0));
    	ROS_INFO("Mass 40 = %f",M_(4,0));
    	ROS_INFO("Mass 50 = %f",M_(5,0));
    	ROS_INFO("Mass 60 = %f",M_(6,0));
    	*/
        ...
        // ROS_INFO("tau_cmd_.data_1= %d",tau_cmd_.data(1));
//        ROS_INFO("tau_cmd_.data_1= %d",M_.data);// added JLF
