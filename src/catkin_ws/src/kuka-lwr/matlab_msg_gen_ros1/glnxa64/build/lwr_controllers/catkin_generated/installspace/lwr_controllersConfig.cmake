...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lwr_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nearlab/catkin_ws/src/kuka-lwr/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nearlab/catkin_ws/src/kuka-lwr/matlab_msg_gen_ros1/glnxa64/install/lib;/usr/local/MATLAB/R2021a/sys/ros1/glnxa64/ros1/lib;/usr/local/MATLAB/R2021a/toolbox/ros/mlroscpp/custom_messages/lib)
